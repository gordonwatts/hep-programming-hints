...
query, tag_tool_info = make_a_tool(
    ...
    init_lines=[
        # Data: <data-type (Opendata/Run2, Run3)>
...
If you are reading open data you *must* uncomment the three lines in the initialization. It won't work otherwise! This is because OpenData (Run 2) uses a different b-tagging algorithm than Run 2 and 3 ATLAS data. Fill in the `<data-type>` blank with OpenData/Run2 or Run3 so that you track what choice of initialization lines below you made. This will help with future debugging.
